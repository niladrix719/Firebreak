...
Runs a full incident against fake Slack/GitHub, no credentials needed. Add `-- --live` with `ANTHROPIC_API_KEY` set to use the real agent instead of the keyword fallback.
...
4. `npm run dev`, then `/incident help` in Slack.
